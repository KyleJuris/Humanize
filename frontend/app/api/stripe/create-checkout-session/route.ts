...
export async function POST(request: NextRequest) {
  console.log('=== STRIPE EMBEDDED CHECKOUT API CALLED (APP ROUTER) ===')
  ...
  try {
    ...
    console.log('Creating Stripe embedded checkout session with priceId:', priceId)
    ...
    // Return success response with client secret for embedded checkout
    return NextResponse.json({
